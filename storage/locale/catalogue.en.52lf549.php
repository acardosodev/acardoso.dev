...
',
    ...
    'bazaar.admin.loader.refresh' => 'Refresh page',
    'bazaar.admin.loader.close' => 'Close',
    'bazaar.admin.loader.report_issue' => 'Report an issue',
    ...
    'bazaar.admin.modal.dashboard.sync.description' => 'Sync your extension information with {host} to receive timely notifications about new versions of extensions you installed. In addition we will send you a regular notification about outdated extensions on all your synced Bazaar enabled Flarum installations.
',
    'bazaar.admin.modal.settings.title' => 'Flagrow Bazaar',
    'bazaar.admin.modal.settings.field.token.label' => 'API token',
    'bazaar.admin.modal.settings.field.token.description' => 'This api token is required to access the Flagrow extension api. If already set, you\'re good to go!',
    'bazaar.admin.modal.settings.field.use_cron_for_tasks.label' => 'Cronjobs',
    'bazaar.admin.modal.settings.field.use_cron_for_tasks.description' => 'By allowing cronjobs to process Bazaar tasks, these processes are less likely to timeout. Please note you need to be able to configure the cronjob, refer to <a>the wiki</a>.
',
    'bazaar.admin.modal.settings.field.use_cron_for_tasks.toggle' => 'Use crons for task processing',
    'bazaar.admin.modal.connect-bazaar.title' => 'Connect',
    'bazaar.admin.modal.connect-bazaar.description' => 'Connect your Flarum forum to your personal account on {host} to unlock advanced features; including a dashboard that gives you an health overview of all your connected Flarum installations. We will add more functionality like notifications when your forum contains outdated extensions or the ability to update all Flarum installations centrally.
',
    'bazaar.admin.modal.requirements.file-permissions.title' => 'File permissions',
    'bazaar.admin.modal.requirements.file-permissions.description' => 'It seems Bazaar has insufficient permissions to write files and/or directories, please review the list below. For further information, refer to <a>the wiki</a>.
',
    'bazaar.admin.modal.requirements.php-memory_limit.title' => 'Memory limit',
    'bazaar.admin.modal.requirements.php-memory_limit.description' => 'We recommend allowing PHP to use at least {required} of memory, your php.ini currently allows {limit}. Although we try to increase the memory limit during runtime, success depends on your hosting environment. For further information, refer to <a>the wiki</a>.
',
    'bazaar.admin.page.state.no_results_available' => 'It seems no results were available at this time.
',
    'bazaar.admin.page.state.not_authorized' => 'Your authorization against our flagrow.io api failed. Possibly an unstable internet connection is causing this. Please refresh the page once your connection stabilised. If the problem persists, please get in touch with us.
',
    ...
    'bazaar.admin.page.button.favorite_button' => 'Favorite extension',
    'bazaar.admin.page.button.remove_favorite_button' => 'Remove extension from your favorites',
    'bazaar.admin.page.button.subscribe' => 'Buy subscription',
    'bazaar.admin.page.button.unsubscribe' => 'Cancel subscription',
    'bazaar.admin.page.button.connect_to_subscribe' => 'Connect your Bazaar to subcribe to extensions',
    ...
    'bazaar.admin.page.extension.outdated' => 'Extension is outdated, please update to version {new}',
    'bazaar.admin.page.extension.premium' => 'Premium',
    'bazaar.admin.page.extension.subscribed' => 'Subscribed',
    'bazaar.admin.page.extension.subscribe_check_failed' => 'It looks like you cancelled the checkout process.',
    'bazaar.admin.page.extension.incompatible' => 'Incompatible with your current Flarum version',
    'bazaar.admin.page.extension.next_incompatible' => 'Incompatible with the upcoming Flarum version',
    'bazaar.admin.page.extension.latest_incompatible' => 'Incompatible with the latest Flarum version',
    ...
    'bazaar.admin.page.task.attribute.created_at' => 'Created at',
    'bazaar.admin.page.task.attribute.started_at' => 'Started at',
    'bazaar.admin.page.task.attribute.finished_at' => 'Finished at',
    ...
    'bazaar.admin.page.task.group.today' => 'Today',
    'bazaar.admin.page.task.group.lastmonth' => 'Last month',
    'bazaar.admin.page.task.group.older' => 'Older',
    'bazaar.admin.search.placeholder' => 'Search extensions',
    'bazaar.admin.search.filter_installed' => 'Installed',
    'bazaar.admin.search.filter_update' => 'Has update',
    ...
    'bazaar.admin.search.filter_languages' => 'Languages',
